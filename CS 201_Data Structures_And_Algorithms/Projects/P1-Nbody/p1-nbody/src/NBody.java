...
public class NBody {
	...
	public static CelestialBody[] readBodies(String fname) throws FileNotFoundException {
		...
		CelestialBody [] storedbodies =new CelestialBody[nb];
		...
		for(int k=0; k < nb; k++) {
			...
			CelestialBody newPlanet = new CelestialBody(s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.nextDouble(), s.next());
			storedbodies[k] = newPlanet;
