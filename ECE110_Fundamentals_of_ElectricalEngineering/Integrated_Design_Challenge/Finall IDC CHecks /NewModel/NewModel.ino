...
void turn90Degrees() {
  ...
  delay(700);  // Adjust the delay based on the time needed to turn 90 degrees
...
void performAction(int currentState) {
  switch (currentState) {
    ...
    case 0:
      ...
      //mySerial.write(12);
      while (teamScores[0] == -1 || teamScores[1] == -1 || teamScores[2] == -1 || teamScores[3] == -1 || teamScores[4] == -1) {
